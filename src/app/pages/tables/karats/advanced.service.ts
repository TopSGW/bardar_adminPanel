...
import { Karats, SearchResult } from '../../../core/models/karats.models';
 ...
 */
function sort(tables: Karats[], column: string, direction: string): Karats[] {
    if (direction === '' || column === '') {
        return tables;
    } else {
...
export class AdvancedService {
    ...
    // tslint:disable-next-line: variable-name
    private _tables$ = new BehaviorSubject<Karats[]>([]);
    // tslint:disable-next-line: variable-name
    ...
    private tableData: Karats[];

    constructor(private pipe: DecimalPipe,private sharedDataService: SharedDataKaratService,) {
