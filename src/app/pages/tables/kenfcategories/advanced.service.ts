...
import { ItemsCategory, SearchResult } from '../../../core/models/items_category.models';
 ...
 */
function sort(tables: ItemsCategory[], column: string, direction: string): ItemsCategory[] {
    if (direction === '' || column === '') {
        return tables;
    } else {
...
export class AdvancedService {
    ...
    // tslint:disable-next-line: variable-name
    private _tables$ = new BehaviorSubject<ItemsCategory[]>([]);
    // tslint:disable-next-line: variable-name
    ...
    private tableData: ItemsCategory[];

    constructor(private pipe: DecimalPipe,private sharedDataService: SharedDataItemsKenfService,) {
