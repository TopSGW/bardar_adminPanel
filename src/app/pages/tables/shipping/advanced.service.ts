...
import { Shipping, SearchResult } from '../../../core/models/shipping.models';
 ...
 */
function sort(tables: Shipping[], column: string, direction: string): Shipping[] {
    if (direction === '' || column === '') {
        return tables;
    } else {
...
export class AdvancedService {
    ...
    // tslint:disable-next-line: variable-name
    private _tables$ = new BehaviorSubject<Shipping[]>([]);
    // tslint:disable-next-line: variable-name
    ...
    private tableData: Shipping[];
    constructor(private pipe: DecimalPipe,private sharedDataService: SharedDataShippingService,) {
